...
const SheetContent = React.forwardRef<
  ...
  SheetContentProps
>(({ side = "right", className, children, isClearBtn, onClear, ...props }, ref) => (
  <SheetPortal>
    <SheetOverlay />
    ...
    >
      {children}
      <SheetPrimitive.Close className="absolute left-4 top-4 z-[10002] rounded-sm opacity-70 ring-offset-background transition-opacity hover:opacity-100 
      ...
      </SheetPrimitive.Close>
      {
        isClearBtn && (
          <button
            className="absolute right-4 top-4 text-sm text-textGray z-[10002]"
            onClick={onClear}
          >
           Clear all
          </button>
