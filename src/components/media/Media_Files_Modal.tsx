...
import AllUploadedFiles, { IFileDataMedia } from "@/pages/media/retrive/all_uploaded_files";
...
function MediaFilesModal({
  ...
  return (
    ...
    >
      ...
      <DrawerContent className="z-[20001] mx-auto max-w-screen-md w-full h-[85vh] max-h-[85vh] flex flex-col rounded-lg border bg-background p-4">
