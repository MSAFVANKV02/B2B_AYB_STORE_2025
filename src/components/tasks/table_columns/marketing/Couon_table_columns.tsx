...
export const CouponTableColumn: ColumnDef<ICouponType>[] = [
  {
    ...
    header: () => (
      <div className="font-bold text-black max-w-32">Coupon Code</div>
    ),
  ...
  },
  {
    ...
    header: () => (
      <div className="font-bold text-black max-w-32">Discount Type</div>
    ),
  ...
  },
  {
    ...
    header: () => (
      <div className="font-bold text-black max-w-32">Discount Amount</div>
    ),
  ...
  },
  {
    ...
    header: () => (
      <div className="font-bold text-black max-w-32">Min Purchase Amount</div>
    ),
  ...
  },
  {
    ...
    header: () => (
      <div className="font-bold text-black max-w-32">Start Date</div>
    ),
    cell: ({ row }) => (
  ...
  },
  {
    ...
    header: () => (
      <div className="font-bold text-black max-w-32">Expiration Date</div>
    ),
    cell: ({ row }) => (
  ...
  },
  {
    ...
    header: () => (
      <div className="font-bold text-black max-w-32">Active Status</div>
    ),
    cell: ({ row }) => (
