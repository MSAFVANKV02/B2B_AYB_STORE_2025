...
//           >
//             <div
//               className={`flex ${message.sender === "user" ? "flex-row-reverse" : "flex-row"} items-end max-w-[75%]`}
//             >
//               <img
...
//               />
//               <div
//                 className={`${message.sender === "user" ? "bg-blue-500 text-white" : "bg-white"} rounded-lg p-3 shadow`}
//               >
...
//           className="fixed bottom-24 right-1/2 bg-gray-200 text-white p-2 rounded-full shadow-lg hover:bg-gray-700 transition-all"
//         >
...
//             className="flex-1 h-10 px-4 py-2 bg-gray-100 rounded-full resize-none focus:outline-none focus:ring-2 focus:ring-blue-500"
//             rows={1}
//           />
  ...
  return (
    <div className="flex flex-col h-[80vh] bg-gray-100 relative">
      ...
      {showScrollButton && (
        <button
          onClick={scrollToBottom}
          className="absolute bottom-28 z-50 right-1/2 bg-gray-200 text-white p-2 rounded-full shadow-lg hover:bg-gray-700 transition-all"
        >
          <Icon icon="icon-park:down" fontSize={20} />
        </button>
      )}
