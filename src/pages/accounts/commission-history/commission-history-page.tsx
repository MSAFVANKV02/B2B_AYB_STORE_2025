...
import { CommissionHistoryColumn } from "@/components/tasks/table_columns/Accounts/commission-history-table-columns";
...
function CommissionHistoryPage() {
  return (
    <div>
      <PageLayoutHeader>
        <h1 className="text-textGray font-bold select-none">Commission history</h1>
      </PageLayoutHeader>
      {/* -=====- */}
      ...
      <div className="page-outer">
        <div className="flex md:flex-row flex-col gap-3">
          <div className={` w-full`}>
            <DataTable data={Orders} columns={CommissionHistoryColumn} />
          </div>
        </div>
      </div>
    </div>
